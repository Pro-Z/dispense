package com.example.dispenseprocessingcompiler;


import com.example.dispenseprocessingannotation.Dispense;
import com.example.dispenseprocessingcompiler.utils.Constants;
import com.example.dispenseprocessingcompiler.utils.Logger;
...
public class AppProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        Set<? extends Element> elements = roundEnv.getElementsAnnotatedWith(Dispense.class);
    ...
    private void generateJavaAppProxyFile(Element element) {
        if (element.getKind() == ElementKind.CLASS) {
            ...
            Dispense annotation = element.getAnnotation(Dispense.class);
